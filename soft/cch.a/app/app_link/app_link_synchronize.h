...
#define OCCUPY_DHM_POWER                                0X0001//除湿模块开关机
#define OCCUPY_DHM_RUN_MODE                             0X0002//运行模式
#define OCCUPY_DHM_SET_HUM                              0X0004//设定湿度
#define OCCUPY_DHM_SET_SPEED                            0X0008//设定风速
#define OCCUPY_DHM_RUN_SPEED                            0X0010//运行风速
#define OCCUPY_DHM_SET_HOT_TEMP                         0X0020//设定制热目标温度
#define OCCUPY_DHM_SET_COLD_TEMP                        0X0040//设定制冷目标温度
#define OCCUPY_DHM_SET_BACK_HOT_TEMP                    0X0080//设定回热目标温度
#define OCCUPY_DHM_REVERSE1                             0X0100//预留
#define OCCUPY_DHM_REVERSE2                             0X0200//预留
#define OCCUPY_DHM_LIST_SYSTEM_RTC                      0X0400//系统RTC
#define OCCUPY_DHM_LIST_MODULE_MESSAGE                  0X0800//除湿模块信息
#define OCCUPY_DHM_LIST_MODULE_MEASURE                  0X1000//除湿模块测量数据
#define OCCUPY_DHM_LIST_SYSTEM_TEMP_HUM                 0X2000//系统测量温湿度
#define OCCUPY_DHM_LIST_TEMP_HUM_DIFF                   0X4000//除湿模块温湿度死区
#define OCCUPY_DHM_LIST_OUT_STATUS                      0X8000//除湿模块输出状态
#define OCCUPY_DHM_LIST_MODULE_CONFIG                   0X00010000//除湿模块设置
#define OCCUPY_DHM_LIST_MODULE_FUN                      0X00020000//除湿模块功能字
#define OCCUPY_DHM_LIST_IEC5_CONGIG                     0X00040000//IEC5新风设置信息
#define OCCUPY_DHM_LIS_IEC5_MESSAGE                     0X00080000//IEC5新风风机信息
